...
**整个Golang的笔记目录，非本文目录（后面会逐渐改至统一）**

> **如果看目录找不到需要查找的资料，可以在此页搜索关键字，便可知道具体分类位置了。**
>
...
+ [function函数](/IT/Coding/Golang/Go-function.md)
...
> 计划做成字典式的笔记，但是如果每个概念都做成一篇笔记的话，目录会很长没有重点。
>
...
#### Day10 - [function函数](/IT/Coding/Golang/Go-function.md)
